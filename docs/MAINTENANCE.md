...
Compare deployed skill directories and symlinks with `~/.local/state/skills/.skill-lock.json`, source `cmd-*`, and plugin registrations

Expected: Each skill has an owner. No broken symlink
