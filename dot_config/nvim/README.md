...
Maintenance and integration contracts live in `~/.dotfiles/ARCHI.md`, in the Neovim section. Edit deployed dotfiles, validate, then capture them with chezmoi. Source-buffer saves do not apply automatically.
